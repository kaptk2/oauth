...
return [
     ...
     *
     */
    'tenant_finder' => \App\Tenancy\SubdomainOrDomainTenantFinder::class,
     ...
     */
    'switch_tenant_tasks' => [
        \App\Tenancy\SwitchTenantDatabaseTask::class,
        \App\Tenancy\SwitchFortifyRoutesTask::class,
        \App\Tenancy\SwitchUrlTask::class,
